...
API_URL = "http://127.0.0.0:8002/v3/analyse/{response_id}/communication"
TEST_FILE = "first_lot.json"
OUTPUT_FILE = "first_lot_results.jsonl"
    ...
    with open(OUTPUT_FILE, "a") as out_f:
        for idx, case in enumerate(test_cases, 1):
            ...
            try:
                ...
                comm_url = f"http://127.0.0.0:8002/v3/analyse/{response_id}/communication"
